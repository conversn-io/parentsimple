...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    url: 'https://parentsimple.org/quiz/elite-university-readiness',
  ...
  alternates: {
    canonical: 'https://parentsimple.org/quiz/elite-university-readiness',
  },
}

export default function EliteUniversityReadinessPage() {
  return (
    <div className="min-h-screen bg-[#F9F6EF]">
      <EliteUniversityReadinessQuiz />
    </div>
  )
}
